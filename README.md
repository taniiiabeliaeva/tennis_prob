...
│
├── notebooks_src/                 
│   ├── 01_data_prior_extraction.ipynb   # Data cleaning and historical prior extraction
│   ├── 02_match_data_engineering.ipynb  # Feature engineering for target match
│   ├── 03_bayesian_inference.ipynb      # PyMC model and MCMC sampling
│   └── 04_posterior_analysis.ipynb      # Visualizations
│
├── results/                        # COMPUTATIONAL OUTPUTS (Generated by ipynb 03)
│   ├── inference_trace.nc          # Full MCMC posterior samples (NetCDF format)
│   └── coefficient_evolution.pkl   # Sequential inference history for stability analysis
│
└── README.md
````
